        ...
        ($mod_name:ident, $env_var:expr) => {
            mod $mod_name {
                ...
                async fn multitenant_ore_order_int2() {
                    ...
                    ore_order_helpers::ore_order_generic(&client, "encrypted_int2", values, "ASC")
                        .await;
                }
                ...
                async fn multitenant_ore_order_int2_desc() {
                    ...
                    let client = connect_as_tenant(&keyset_id($env_var)).await;
                    let values: Vec<i16> = vec![-100, -10, -1, 0, 1, 5, 10, 20, 100, 200];
                    ore_order_helpers::ore_order_generic(&client, "encrypted_int2", values, "DESC")
                        .await;
                }
                ...
                async fn multitenant_ore_order_int4() {
                    ...
                    ore_order_helpers::ore_order_generic(&client, "encrypted_int4", values, "ASC")
                        .await;
                }
                ...
                async fn multitenant_ore_order_int4_desc() {
                    ...
                    ore_order_helpers::ore_order_generic(&client, "encrypted_int4", values, "DESC")
                        .await;
                }
                ...
                async fn multitenant_ore_order_int8() {
                    ...
                    ore_order_helpers::ore_order_generic(&client, "encrypted_int8", values, "ASC")
                        .await;
                }
                ...
                async fn multitenant_ore_order_int8_desc() {
                    ...
                    ore_order_helpers::ore_order_generic(&client, "encrypted_int8", values, "DESC")
                        .await;
                }
